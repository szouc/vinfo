...
export const FETCH_COMPANY_ALL_REQUEST = defineConstant('FETCH_COMPANY_ALL_REQUEST')
export const FETCH_COMPANY_ALL_SUCCESS = defineConstant('FETCH_COMPANY_ALL_SUCCESS')
