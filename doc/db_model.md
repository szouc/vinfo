...
| getUsersWithPg       | pageNumber:Number, pageSize:Number, [values: {role: enum, fromDate: moment, toDate: moment }] | Observable | 根据查询参数获取具体页面的用户 |
...
| getCompaniesWithPg | pageNumber:Number,pageSize:Number, [values:{fromDate:Date,toDate:Date}] | Observable | 根据查询条件获取具体页面公司 |
...
| getProductsWithPg         | pageNumber:Number,pageSize:Number | Observable | 获取具体页面产品     |
...
|getVehiclesWithPg|pageNumber:Number,pageSize:Number|Observable|获取具体页面车辆|
|getDriverVehiclesWithPg|pageNumber:Number,pageSize:Number,username:String|Observable|获取司机具体页面车辆|
|getCaptainVehiclesWithPg|pageNumber:Number,pageSize:Number,username:String|Observable|获取队长具体页面车辆|
|getVehicleById|id:ObjectId|Observable|根据id获取车辆|
|deleteVehicleById|id:ObjectId|Observable|根据id删除车辆|
|updateVehicleById|id:ObjectId|Observable|根据id更新车辆|
