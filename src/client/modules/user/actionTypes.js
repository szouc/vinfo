...
export const FETCH_DRIVER_REQUEST = addUserPrefix('FETCH_DRIVER_REQUEST')
export const FETCH_DRIVER_SUCCESS = addUserPrefix('FETCH_DRIVER_SUCCESS')
export const FETCH_CAPTAIN_REQUEST = addUserPrefix('FETCH_CAPTAIN_REQUEST')
export const FETCH_CAPTAIN_SUCCESS = addUserPrefix('FETCH_CAPTAIN_SUCCESS')
